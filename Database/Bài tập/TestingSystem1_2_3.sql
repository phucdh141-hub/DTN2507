...
VALUES                ('dophuc141Produce@gmail.com'        , 'phucca141'      , 'Do Huy Phuc'             ,    '1'          ,      '1'     ,'2025-11-14'),
                      ...
                      ('account2@gmail.com'                , 'account2'       , 'Duong Do'                ,     1           ,      '3'     ,'2023-03-07'),
                      ('account3@gmail.com'                , 'coconut'        , 'Tran Thi Quynh Trang'    ,     '3'         ,      '4'     ,'2023-03-08'),
                      ('admin1@gmail.com'                  , 'admin'          , 'A Do Min'                ,     '2'         ,      '4'     ,'2023-03-09'),
                      ('account9@gmail.com'                , 'account9'       , 'Nguyen Chien Thang'      ,     '6'         ,      '3'     ,'2023-04-10'),
                      ('mtp@gmail.com'                     , 'sontungmtp'     , 'MTP'                     ,     '10'        ,      '2'     ,'2023-05-14'),
                      ('account11@gmail.com'               , 'account11'      , 'Duong Do'                ,     '1'         ,      '1'     ,'2023-06-11'),
                      ('account5@gmail.com'                , 'account5'       , 'Tran Minh Hieu'          ,      2          ,      '1'     ,'2024-03-05'),
...
VALUES						('Câu hỏi SQL'		, 1			  , 1			, 2			, '2022-11-11'),
							...
							('Câu hỏi OS'		, 7			  , 2			, 5			, '2023-10-01'),
							('Câu hỏi Security' , 5			  , 1			, 7			, '2023-03-01'),
							('Câu hỏi Testing'  , 2			  , 2			, 8			, '2022-12-31'),
							('Câu hỏi AI'		, 4			  , 1			, 9			, '2023-02-01'),
							('Câu hỏi Hardware' , 8 		  , 2			, 10		, '2023-10-29');
...
VALUES 			 	('EX001','Đề SQL'		,1			, 90		,	1		,'2023-11-01'),
					...
					('EX003','Đề Python'	,3			, 60		,	3		,'2023-12-10'),
					('EX004','Đề C++'		,4			, 30		,	4		,'2023-08-01'),
					('EX005','Đề AI'		,5			, 120 		,	5		,'2023-07-20'),
					('EX006','Đề OS'		,6			, 75		,	6		,'2023-09-12'),
					('EX007','Đề Network'	,7			, 100		,	7		,'2022-11-11'),
					('EX008','Đề Security'	,8			, 60		,	8		,'2023-12-20'),
					('EX009','Đề Testing'	,9			, 45		,	9		,'2023-10-01'),
